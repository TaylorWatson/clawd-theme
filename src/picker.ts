...
import { getAllThemes, getTheme, type ThemeName } from './themes/index.js';
import { loadClawdConfig, saveClawdConfig } from './utils/config.js';
import { renderClawd } from './utils/renderer.js';

const THEMES: ThemeName[] = ['normal', 'winter', 'halloween', 'valentines', 'spring', 'summer'];
...
function renderPicker(selectedIndex: number, autoSeasonal: boolean): void {
  clearScreen();
